...
type FeedHeader struct {
	...
	Incrementality      *FeedHeader_Incrementality `protobuf:"varint,2,opt,name=incrementality,enum=FeedHeader_Incrementality,def=0" json:"incrementality,omitempty"`
...
type VehiclePosition struct {
	...
	CurrentStatus *VehiclePosition_VehicleStopStatus `protobuf:"varint,4,opt,name=current_status,json=currentStatus,enum=VehiclePosition_VehicleStopStatus,def=2" json:"current_status,omitempty"`
	// Moment at which the vehicle's position was measured. In POSIX time
	// (i.e., number of seconds since January 1st 1970 00:00:00 UTC).
	Timestamp       *uint64                          `protobuf:"varint,5,opt,name=timestamp" json:"timestamp,omitempty"`
	CongestionLevel *VehiclePosition_CongestionLevel `protobuf:"varint,6,opt,name=congestion_level,json=congestionLevel,enum=VehiclePosition_CongestionLevel" json:"congestion_level,omitempty"`
	// If multi_carriage_status is populated with per-carriage OccupancyStatus,
	// then this field should describe the entire vehicle with all carriages accepting passengers considered.
	OccupancyStatus *VehiclePosition_OccupancyStatus `protobuf:"varint,9,opt,name=occupancy_status,json=occupancyStatus,enum=VehiclePosition_OccupancyStatus" json:"occupancy_status,omitempty"`
...
type Alert struct {
	...
	Cause          *Alert_Cause      `protobuf:"varint,6,opt,name=cause,enum=Alert_Cause,def=1" json:"cause,omitempty"`
	Effect         *Alert_Effect     `protobuf:"varint,7,opt,name=effect,enum=Alert_Effect,def=8" json:"effect,omitempty"`
	...
	SeverityLevel      *Alert_SeverityLevel `protobuf:"varint,14,opt,name=severity_level,json=severityLevel,enum=Alert_SeverityLevel,def=1" json:"severity_level,omitempty"`
...
type TripDescriptor struct {
	...
	ScheduleRelationship *TripDescriptor_ScheduleRelationship `protobuf:"varint,4,opt,name=schedule_relationship,json=scheduleRelationship,enum=TripDescriptor_ScheduleRelationship" json:"schedule_relationship,omitempty"`
...
type VehicleDescriptor struct {
	...
	WheelchairAccessible *VehicleDescriptor_WheelchairAccessible `protobuf:"varint,4,opt,name=wheelchair_accessible,json=wheelchairAccessible,enum=VehicleDescriptor_WheelchairAccessible,def=0" json:"wheelchair_accessible,omitempty"`
	extensionFields      protoimpl.ExtensionFields
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type Stop struct {
	...
	WheelchairBoarding *Stop_WheelchairBoarding `protobuf:"varint,13,opt,name=wheelchair_boarding,json=wheelchairBoarding,enum=Stop_WheelchairBoarding,def=0" json:"wheelchair_boarding,omitempty"`
...
type TripUpdate_StopTimeUpdate struct {
	...
	DepartureOccupancyStatus *VehiclePosition_OccupancyStatus                `protobuf:"varint,7,opt,name=departure_occupancy_status,json=departureOccupancyStatus,enum=VehiclePosition_OccupancyStatus" json:"departure_occupancy_status,omitempty"`
	ScheduleRelationship     *TripUpdate_StopTimeUpdate_ScheduleRelationship `protobuf:"varint,5,opt,name=schedule_relationship,json=scheduleRelationship,enum=TripUpdate_StopTimeUpdate_ScheduleRelationship,def=0" json:"schedule_relationship,omitempty"`
...
func (x *TripUpdate_StopTimeUpdate_StopTimeProperties) GetHistoric() bool {
	if x != nil && x.Historic != nil {
		return *x.Historic
	}
	return false
}
...
type VehiclePosition_CarriageDetails struct {
	...
	// This message/field is still experimental, and subject to change. It may be formally adopted in the future.
	OccupancyStatus *VehiclePosition_OccupancyStatus `protobuf:"varint,3,opt,name=occupancy_status,json=occupancyStatus,enum=VehiclePosition_OccupancyStatus,def=7" json:"occupancy_status,omitempty"`
...
const file_gtfs_realtime_proto_rawDesc = "" +
	"\n" +
	"\x13gtfs-realtime.proto\"g\n" +
	"\vFeedMessage\x12#\n" +
	"\x06header\x18\x01 \x02(\v2\v.FeedHeaderR\x06header\x12#\n" +
	"\x06entity\x18\x02 \x03(\v2\v.FeedEntityR\x06entity*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\x99\x02\n" +
	"\n" +
	"FeedHeader\x122\n" +
	"\x15gtfs_realtime_version\x18\x01 \x02(\tR\x13gtfsRealtimeVersion\x12P\n" +
	"\x0eincrementality\x18\x02 \x01(\x0e2\x1a.FeedHeader.Incrementality:\fFULL_DATASETR\x0eincrementality\x12\x1c\n" +
	...
	"\fDIFFERENTIAL\x10\x01*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xc6\x02\n" +
	"\n" +
	"FeedEntity\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\tR\x02id\x12$\n" +
	"\n" +
	"is_deleted\x18\x02 \x01(\b:\x05falseR\tisDeleted\x12,\n" +
	"\vtrip_update\x18\x03 \x01(\v2\v.TripUpdateR\n" +
	"tripUpdate\x12*\n" +
	"\avehicle\x18\x04 \x01(\v2\x10.VehiclePositionR\avehicle\x12\x1c\n" +
	"\x05alert\x18\x05 \x01(\v2\x06.AlertR\x05alert\x12\x1c\n" +
	"\x05shape\x18\x06 \x01(\v2\x06.ShapeR\x05shape\x12\x19\n" +
	"\x04stop\x18\a \x01(\v2\x05.StopR\x04stop\x12A\n" +
	"\x12trip_modifications\x18\b \x01(\v2\x12.TripModificationsR\x11tripModifications*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xd3\t\n" +
	"\n" +
	"TripUpdate\x12#\n" +
	"\x04trip\x18\x01 \x02(\v2\x0f.TripDescriptorR\x04trip\x12,\n" +
	"\avehicle\x18\x03 \x01(\v2\x12.VehicleDescriptorR\avehicle\x12D\n" +
	"\x10stop_time_update\x18\x02 \x03(\v2\x1a.TripUpdate.StopTimeUpdateR\x0estopTimeUpdate\x12\x1c\n" +
	"\ttimestamp\x18\x04 \x01(\x04R\ttimestamp\x12\x14\n" +
	"\x05delay\x18\x05 \x01(\x05R\x05delay\x12C\n" +
	"\x0ftrip_properties\x18\x06 \x01(\v2\x1a.TripUpdate.TripPropertiesR\x0etripProperties\x1ak\n" +
	"\rStopTimeEvent\x12\x14\n" +
	"\x05delay\x18\x01 \x01(\x05R\x05delay\x12\x12\n" +
	"\x04time\x18\x02 \x01(\x03R\x04time\x12 \n" +
	"\vuncertainty\x18\x03 \x01(\x05R\vuncertainty*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\x1a\xa0\x05\n" +
	"\x0eStopTimeUpdate\x12#\n" +
	"\rstop_sequence\x18\x01 \x01(\rR\fstopSequence\x12\x17\n" +
	"\astop_id\x18\x04 \x01(\tR\x06stopId\x123\n" +
	"\aarrival\x18\x02 \x01(\v2\x19.TripUpdate.StopTimeEventR\aarrival\x127\n" +
	"\tdeparture\x18\x03 \x01(\v2\x19.TripUpdate.StopTimeEventR\tdeparture\x12^\n" +
	"\x1adeparture_occupancy_status\x18\a \x01(\x0e2 .VehiclePosition.OccupancyStatusR\x18departureOccupancyStatus\x12o\n" +
	"\x15schedule_relationship\x18\x05 \x01(\x0e2/.TripUpdate.StopTimeUpdate.ScheduleRelationship:\tSCHEDULEDR\x14scheduleRelationship\x12_\n" +
	"\x14stop_time_properties\x18\x06 \x01(\v2-.TripUpdate.StopTimeUpdate.StopTimePropertiesR\x12stopTimeProperties\x1aN\n" +
	...
	"\bshape_id\x18\x04 \x01(\tR\ashapeId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xb7\n" +
	"\n" +
	"\x0fVehiclePosition\x12#\n" +
	"\x04trip\x18\x01 \x01(\v2\x0f.TripDescriptorR\x04trip\x12,\n" +
	"\avehicle\x18\b \x01(\v2\x12.VehicleDescriptorR\avehicle\x12%\n" +
	"\bposition\x18\x02 \x01(\v2\t.PositionR\bposition\x122\n" +
	"\x15current_stop_sequence\x18\x03 \x01(\rR\x13currentStopSequence\x12\x17\n" +
	"\astop_id\x18\a \x01(\tR\x06stopId\x12X\n" +
	"\x0ecurrent_status\x18\x04 \x01(\x0e2\".VehiclePosition.VehicleStopStatus:\rIN_TRANSIT_TOR\rcurrentStatus\x12\x1c\n" +
	"\ttimestamp\x18\x05 \x01(\x04R\ttimestamp\x12K\n" +
	"\x10congestion_level\x18\x06 \x01(\x0e2 .VehiclePosition.CongestionLevelR\x0fcongestionLevel\x12K\n" +
	"\x10occupancy_status\x18\t \x01(\x0e2 .VehiclePosition.OccupancyStatusR\x0foccupancyStatus\x121\n" +
	"\x14occupancy_percentage\x18\n" +
	" \x01(\rR\x13occupancyPercentage\x12V\n" +
	"\x16multi_carriage_details\x18\v \x03(\v2 .VehiclePosition.CarriageDetailsR\x14multiCarriageDetails\x1a\x8b\x02\n" +
	"\x0fCarriageDetails\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12^\n" +
	"\x10occupancy_status\x18\x03 \x01(\x0e2 .VehiclePosition.OccupancyStatus:\x11NO_DATA_AVAILABLER\x0foccupancyStatus\x125\n" +
	...
	"\rNOT_BOARDABLE\x10\b*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xb6\n" +
	"\n" +
	"\x05Alert\x12/\n" +
	"\ractive_period\x18\x01 \x03(\v2\n" +
	".TimeRangeR\factivePeriod\x128\n" +
	"\x0finformed_entity\x18\x05 \x03(\v2\x0f.EntitySelectorR\x0einformedEntity\x121\n" +
	"\x05cause\x18\x06 \x01(\x0e2\f.Alert.Cause:\rUNKNOWN_CAUSER\x05cause\x125\n" +
	"\x06effect\x18\a \x01(\x0e2\r.Alert.Effect:\x0eUNKNOWN_EFFECTR\x06effect\x12#\n" +
	"\x03url\x18\b \x01(\v2\x11.TranslatedStringR\x03url\x122\n" +
	"\vheader_text\x18\n" +
	" \x01(\v2\x11.TranslatedStringR\n" +
	"headerText\x12<\n" +
	"\x10description_text\x18\v \x01(\v2\x11.TranslatedStringR\x0fdescriptionText\x129\n" +
	"\x0ftts_header_text\x18\f \x01(\v2\x11.TranslatedStringR\rttsHeaderText\x12C\n" +
	"\x14tts_description_text\x18\r \x01(\v2\x11.TranslatedStringR\x12ttsDescriptionText\x12M\n" +
	"\x0eseverity_level\x18\x0e \x01(\x0e2\x14.Alert.SeverityLevel:\x10UNKNOWN_SEVERITYR\rseverityLevel\x12&\n" +
	"\x05image\x18\x0f \x01(\v2\x10.TranslatedImageR\x05image\x12G\n" +
	"\x16image_alternative_text\x18\x10 \x01(\v2\x11.TranslatedStringR\x14imageAlternativeText\x124\n" +
	"\fcause_detail\x18\x11 \x01(\v2\x11.TranslatedStringR\vcauseDetail\x126\n" +
	"\reffect_detail\x18\x12 \x01(\v2\x11.TranslatedStringR\feffectDetail\"\xd8\x01\n" +
	"\x05Cause\x12\x11\n" +
	...
	"\x05speed\x18\x05 \x01(\x02R\x05speed*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\x9b\x05\n" +
	...
	"\n" +
	"start_date\x18\x03 \x01(\tR\tstartDate\x12Y\n" +
	"\x15schedule_relationship\x18\x04 \x01(\x0e2$.TripDescriptor.ScheduleRelationshipR\x14scheduleRelationship\x12I\n" +
	"\rmodified_trip\x18\a \x01(\v2$.TripDescriptor.ModifiedTripSelectorR\fmodifiedTrip\x1a\xb9\x01\n" +
	...
	"\aDELETED\x10\a*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xc1\x02\n" +
	"\x11VehicleDescriptor\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12#\n" +
	"\rlicense_plate\x18\x03 \x01(\tR\flicensePlate\x12f\n" +
	"\x15wheelchair_accessible\x18\x04 \x01(\x0e2'.VehicleDescriptor.WheelchairAccessible:\bNO_VALUER\x14wheelchairAccessible\"i\n" +
	"\x14WheelchairAccessible\x12\f\n" +
	"\bNO_VALUE\x10\x00\x12\v\n" +
	"\aUNKNOWN\x10\x01\x12\x19\n" +
	"\x15WHEELCHAIR_ACCESSIBLE\x10\x02\x12\x1b\n" +
	"\x17WHEELCHAIR_INACCESSIBLE\x10\x03*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xd8\x01\n" +
	...
	"\x04trip\x18\x04 \x01(\v2\x0f.TripDescriptorR\x04trip\x12\x17\n" +
	"\astop_id\x18\x05 \x01(\tR\x06stopId\x12!\n" +
	"\fdirection_id\x18\x06 \x01(\rR\vdirectionId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xb2\x01\n" +
	"\x10TranslatedString\x12?\n" +
	"\vtranslation\x18\x01 \x03(\v2\x1d.TranslatedString.TranslationR\vtranslation\x1aM\n" +
	"\vTranslation\x12\x12\n" +
	"\x04text\x18\x01 \x02(\tR\x04text\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xda\x01\n" +
	"\x0fTranslatedImage\x12H\n" +
	"\x0flocalized_image\x18\x01 \x03(\v2\x1f.TranslatedImage.LocalizedImageR\x0elocalizedImage\x1am\n" +
	...
	"\x10encoded_polyline\x18\x02 \x01(\tR\x0fencodedPolyline*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xab\x05\n" +
	"\x04Stop\x12\x17\n" +
	"\astop_id\x18\x01 \x01(\tR\x06stopId\x12.\n" +
	"\tstop_code\x18\x02 \x01(\v2\x11.TranslatedStringR\bstopCode\x12.\n" +
	"\tstop_name\x18\x03 \x01(\v2\x11.TranslatedStringR\bstopName\x125\n" +
	"\rtts_stop_name\x18\x04 \x01(\v2\x11.TranslatedStringR\vttsStopName\x12.\n" +
	"\tstop_desc\x18\x05 \x01(\v2\x11.TranslatedStringR\bstopDesc\x12\x19\n" +
	"\bstop_lat\x18\x06 \x01(\x02R\astopLat\x12\x19\n" +
	"\bstop_lon\x18\a \x01(\x02R\astopLon\x12\x17\n" +
	"\azone_id\x18\b \x01(\tR\x06zoneId\x12,\n" +
	"\bstop_url\x18\t \x01(\v2\x11.TranslatedStringR\astopUrl\x12%\n" +
	"\x0eparent_station\x18\v \x01(\tR\rparentStation\x12#\n" +
	"\rstop_timezone\x18\f \x01(\tR\fstopTimezone\x12R\n" +
	"\x13wheelchair_boarding\x18\r \x01(\x0e2\x18.Stop.WheelchairBoarding:\aUNKNOWNR\x12wheelchairBoarding\x12\x19\n" +
	"\blevel_id\x18\x0e \x01(\tR\alevelId\x126\n" +
	"\rplatform_code\x18\x0f \x01(\v2\x11.TranslatedStringR\fplatformCode\"C\n" +
	"\x12WheelchairBoarding\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\r\n" +
	"\tAVAILABLE\x10\x01\x12\x11\n" +
	"\rNOT_AVAILABLE\x10\x02*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xc9\x05\n" +
	"\x11TripModifications\x12G\n" +
	"\x0eselected_trips\x18\x01 \x03(\v2 .TripModifications.SelectedTripsR\rselectedTrips\x12\x1f\n" +
	"\vstart_times\x18\x02 \x03(\tR\n" +
	"startTimes\x12#\n" +
	"\rservice_dates\x18\x03 \x03(\tR\fserviceDates\x12E\n" +
	"\rmodifications\x18\x04 \x03(\v2\x1f.TripModifications.ModificationR\rmodifications\x1a\xf6\x02\n" +
	"\fModification\x12=\n" +
	"\x13start_stop_selector\x18\x01 \x01(\v2\r.StopSelectorR\x11startStopSelector\x129\n" +
	"\x11end_stop_selector\x18\x02 \x01(\v2\r.StopSelectorR\x0fendStopSelector\x12E\n" +
	"\x1dpropagated_modification_delay\x18\x03 \x01(\x05:\x010R\x1bpropagatedModificationDelay\x12=\n" +
	"\x11replacement_stops\x18\x04 \x03(\v2\x10.ReplacementStopR\x10replacementStops\x12(\n" +
	...
	"\astop_id\x18\x02 \x01(\tR\x06stopId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90NB\x1dZ\x1bgithub.com/jfmow/gtfs/proto"
...
var file_gtfs_realtime_proto_goTypes = []any{
	(FeedHeader_Incrementality)(0),                       // 0: FeedHeader.Incrementality
	(TripUpdate_StopTimeUpdate_ScheduleRelationship)(0),  // 1: TripUpdate.StopTimeUpdate.ScheduleRelationship
	(VehiclePosition_VehicleStopStatus)(0),               // 2: VehiclePosition.VehicleStopStatus
	(VehiclePosition_CongestionLevel)(0),                 // 3: VehiclePosition.CongestionLevel
	(VehiclePosition_OccupancyStatus)(0),                 // 4: VehiclePosition.OccupancyStatus
	(Alert_Cause)(0),                                     // 5: Alert.Cause
	(Alert_Effect)(0),                                    // 6: Alert.Effect
	(Alert_SeverityLevel)(0),                             // 7: Alert.SeverityLevel
	(TripDescriptor_ScheduleRelationship)(0),             // 8: TripDescriptor.ScheduleRelationship
	(VehicleDescriptor_WheelchairAccessible)(0),          // 9: VehicleDescriptor.WheelchairAccessible
	(Stop_WheelchairBoarding)(0),                         // 10: Stop.WheelchairBoarding
	(*FeedMessage)(nil),                                  // 11: FeedMessage
	(*FeedHeader)(nil),                                   // 12: FeedHeader
	(*FeedEntity)(nil),                                   // 13: FeedEntity
	(*TripUpdate)(nil),                                   // 14: TripUpdate
	(*VehiclePosition)(nil),                              // 15: VehiclePosition
	(*Alert)(nil),                                        // 16: Alert
	(*TimeRange)(nil),                                    // 17: TimeRange
	(*Position)(nil),                                     // 18: Position
	(*TripDescriptor)(nil),                               // 19: TripDescriptor
	(*VehicleDescriptor)(nil),                            // 20: VehicleDescriptor
	(*EntitySelector)(nil),                               // 21: EntitySelector
	(*TranslatedString)(nil),                             // 22: TranslatedString
	(*TranslatedImage)(nil),                              // 23: TranslatedImage
	(*Shape)(nil),                                        // 24: Shape
	(*Stop)(nil),                                         // 25: Stop
	(*TripModifications)(nil),                            // 26: TripModifications
	(*StopSelector)(nil),                                 // 27: StopSelector
	(*ReplacementStop)(nil),                              // 28: ReplacementStop
	(*TripUpdate_StopTimeEvent)(nil),                     // 29: TripUpdate.StopTimeEvent
	(*TripUpdate_StopTimeUpdate)(nil),                    // 30: TripUpdate.StopTimeUpdate
	(*TripUpdate_TripProperties)(nil),                    // 31: TripUpdate.TripProperties
	(*TripUpdate_StopTimeUpdate_StopTimeProperties)(nil), // 32: TripUpdate.StopTimeUpdate.StopTimeProperties
	(*VehiclePosition_CarriageDetails)(nil),              // 33: VehiclePosition.CarriageDetails
	(*TripDescriptor_ModifiedTripSelector)(nil),          // 34: TripDescriptor.ModifiedTripSelector
	(*TranslatedString_Translation)(nil),                 // 35: TranslatedString.Translation
	(*TranslatedImage_LocalizedImage)(nil),               // 36: TranslatedImage.LocalizedImage
	(*TripModifications_Modification)(nil),               // 37: TripModifications.Modification
	(*TripModifications_SelectedTrips)(nil),              // 38: TripModifications.SelectedTrips
}
var file_gtfs_realtime_proto_depIdxs = []int32{
	12, // 0: FeedMessage.header:type_name -> FeedHeader
	13, // 1: FeedMessage.entity:type_name -> FeedEntity
	0,  // 2: FeedHeader.incrementality:type_name -> FeedHeader.Incrementality
	14, // 3: FeedEntity.trip_update:type_name -> TripUpdate
	15, // 4: FeedEntity.vehicle:type_name -> VehiclePosition
	16, // 5: FeedEntity.alert:type_name -> Alert
	24, // 6: FeedEntity.shape:type_name -> Shape
	25, // 7: FeedEntity.stop:type_name -> Stop
	26, // 8: FeedEntity.trip_modifications:type_name -> TripModifications
	19, // 9: TripUpdate.trip:type_name -> TripDescriptor
	20, // 10: TripUpdate.vehicle:type_name -> VehicleDescriptor
	30, // 11: TripUpdate.stop_time_update:type_name -> TripUpdate.StopTimeUpdate
	31, // 12: TripUpdate.trip_properties:type_name -> TripUpdate.TripProperties
	19, // 13: VehiclePosition.trip:type_name -> TripDescriptor
	20, // 14: VehiclePosition.vehicle:type_name -> VehicleDescriptor
	18, // 15: VehiclePosition.position:type_name -> Position
	2,  // 16: VehiclePosition.current_status:type_name -> VehiclePosition.VehicleStopStatus
	3,  // 17: VehiclePosition.congestion_level:type_name -> VehiclePosition.CongestionLevel
	4,  // 18: VehiclePosition.occupancy_status:type_name -> VehiclePosition.OccupancyStatus
	33, // 19: VehiclePosition.multi_carriage_details:type_name -> VehiclePosition.CarriageDetails
	17, // 20: Alert.active_period:type_name -> TimeRange
	21, // 21: Alert.informed_entity:type_name -> EntitySelector
	5,  // 22: Alert.cause:type_name -> Alert.Cause
	6,  // 23: Alert.effect:type_name -> Alert.Effect
	22, // 24: Alert.url:type_name -> TranslatedString
	22, // 25: Alert.header_text:type_name -> TranslatedString
	22, // 26: Alert.description_text:type_name -> TranslatedString
	22, // 27: Alert.tts_header_text:type_name -> TranslatedString
	22, // 28: Alert.tts_description_text:type_name -> TranslatedString
	7,  // 29: Alert.severity_level:type_name -> Alert.SeverityLevel
	23, // 30: Alert.image:type_name -> TranslatedImage
	22, // 31: Alert.image_alternative_text:type_name -> TranslatedString
	22, // 32: Alert.cause_detail:type_name -> TranslatedString
	22, // 33: Alert.effect_detail:type_name -> TranslatedString
	8,  // 34: TripDescriptor.schedule_relationship:type_name -> TripDescriptor.ScheduleRelationship
	34, // 35: TripDescriptor.modified_trip:type_name -> TripDescriptor.ModifiedTripSelector
	9,  // 36: VehicleDescriptor.wheelchair_accessible:type_name -> VehicleDescriptor.WheelchairAccessible
	19, // 37: EntitySelector.trip:type_name -> TripDescriptor
	35, // 38: TranslatedString.translation:type_name -> TranslatedString.Translation
	36, // 39: TranslatedImage.localized_image:type_name -> TranslatedImage.LocalizedImage
	22, // 40: Stop.stop_code:type_name -> TranslatedString
	22, // 41: Stop.stop_name:type_name -> TranslatedString
	22, // 42: Stop.tts_stop_name:type_name -> TranslatedString
	22, // 43: Stop.stop_desc:type_name -> TranslatedString
	22, // 44: Stop.stop_url:type_name -> TranslatedString
	10, // 45: Stop.wheelchair_boarding:type_name -> Stop.WheelchairBoarding
	22, // 46: Stop.platform_code:type_name -> TranslatedString
	38, // 47: TripModifications.selected_trips:type_name -> TripModifications.SelectedTrips
	37, // 48: TripModifications.modifications:type_name -> TripModifications.Modification
	29, // 49: TripUpdate.StopTimeUpdate.arrival:type_name -> TripUpdate.StopTimeEvent
	29, // 50: TripUpdate.StopTimeUpdate.departure:type_name -> TripUpdate.StopTimeEvent
	4,  // 51: TripUpdate.StopTimeUpdate.departure_occupancy_status:type_name -> VehiclePosition.OccupancyStatus
	1,  // 52: TripUpdate.StopTimeUpdate.schedule_relationship:type_name -> TripUpdate.StopTimeUpdate.ScheduleRelationship
	32, // 53: TripUpdate.StopTimeUpdate.stop_time_properties:type_name -> TripUpdate.StopTimeUpdate.StopTimeProperties
	4,  // 54: VehiclePosition.CarriageDetails.occupancy_status:type_name -> VehiclePosition.OccupancyStatus
	27, // 55: TripModifications.Modification.start_stop_selector:type_name -> StopSelector
	27, // 56: TripModifications.Modification.end_stop_selector:type_name -> StopSelector
	28, // 57: TripModifications.Modification.replacement_stops:type_name -> ReplacementStop
